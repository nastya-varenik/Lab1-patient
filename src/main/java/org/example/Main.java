...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            // Создание пациентов
            Patient patient1 = PatientFactory.createPatient(12345L, "Ivanov", "Ivan", "Ivanovich", "Moscow", "+79161234567", "10000001", "Flu");
            Patient patient2 = PatientFactory.createPatient(12346L, "Petrov", "Petr", "Petrovich", "Moscow", "+79161234568", "10000002", "Cold");
            Patient patient3 = PatientFactory.createPatient(12347L, "Sidorov", "Sidor", "Sidorovich", "Moscow", "+79161234569", "10000003", "Flu");
